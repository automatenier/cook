...
tags:
  - consulting
---
# Client 2 — [CLIENT NAME] | Execution Worksheet
...
| **Client Name** | Fadli |
| **Day** | 7 |
| **Phase** | Full Content Batch (Day 7 AUTO block) |
| **Last Completed** | Day 6 — VSL script drafted |
| **⏸️ Paused — Waiting For** | Jordan: confirm avatar style (Talking Head / Voiceover / Mixed) + brand colors before rendering |
...
|---|---|
| **Full Name** | Fadli |
| **IG Handle** | ⚠️ [ask Jordan] |
| **Email** | ⚠️ [ask Jordan] |
| **WhatsApp** | ⚠️ [ask Jordan] |
| **Niche** | Online fitness / health / lifestyle transformation coach |
| **Avatar (1 sentence)** | Indonesian men/women 25–40 yang mau transformasi fisik tapi selalu gagal konsisten karena nggak ada panduan yang tepat. |
| **Package** | Bedah Digital |
| **Payment Date** | ⚠️ [ask Jordan — amount + date] |
| **Day 14 Call Date** | 07 Mar 2026 |
| **GDrive Folder** | *(collected Day 0)* |
| **Telegram Channel** | *(set up Day 0)* |
| **Netlify URL** | *(collected Day 4)* |
| **Google Calendar Link** | *(collected Day 0)* |
...
|---|------|--------------|-----------|------------------------|
| 1 | 2026-02-21 | Day 0 onboarding — assumed complete | — | Day 1 |
| 2 | 2026-02-22 | Day 1 kickoff — onboarding + brand assets collection | Waiting for client assets | Day 2 |
| 3 | 2026-02-23 | Day 2 full build — offer sheet, swipe file, email sequence | Jordan to approve offer sheet | Day 3 |
| 4 | 2026-02-24–27 | Days 3–6 — VSL, filming brief, content audit, VSL script | Avatar style + brand colors unconfirmed | Day 7 content batch |
| 5 | 2026-02-28 | Day 7 — Full content batch in progress | Calendar approval pending | Day 8 |
...
**Status:** 🟡 In Progress — TODAY (2026-02-28)
