...
tags:
  - consulting
---
# [CLIENT NAME] | Execution Worksheet

> **MASTER TEMPLATE** — To onboard a new client:
> 1. Duplicate this file → rename to `Client_X_Worksheet.md`
> 2. Fill in the Client Profile section
> 3. Say `"Execute [Client Name] workflow"` — I take it from there.
...
| **Phase** | Not started |
| **Last Completed** | — |
| **⏸️ Paused — Waiting For** | Nothing — ready to start |
...
- Module GDrive link → **FIXED** (hardcoded in template, no input needed): `https://drive.google.com/drive/folders/DEMO_JOConsult_Modules_AI_Scale`
