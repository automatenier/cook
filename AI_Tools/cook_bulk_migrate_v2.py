#!/usr/bin/env python3
"""
Bulk Migrate Excel files using Service Account.
"""
import json
import os
import sys
...
def migrate_file(gc, file_path):
    ...
    try:
        sh = gc.create(title)
        # Service accounts own the files they create. 
        # We don't need to share with human yet because we'll do it later or human can be added as editor.
    except Exception as e:
...
def main():
    ...
    parser.add_argument("--share", help="Email to share all sheets with (your email)")
